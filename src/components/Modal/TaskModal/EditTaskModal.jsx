...
import "../BoardModal/boardModal.css";
        ...
        >
          ...
          <div className="modal__input-container">
            ...
            <textarea
              ...
              className={`modal-input input-area ${errorDescription && "modal-input__error"
                }`}
            />
          </div>
              ...
              {subtasks.map((subtask, index) => (
                <div className="modal__subtask" key={index}>
                  <input
                    ...
                    className={`modal-input ${errorSubtaskIndex.includes(index) && "modal-input__error"
                      }`}
                  />
                  <button
              ...
              {openDropdown && (
                <div className="dropdown__options">
                  {activeBoard.columns.map((col, index) => (
                    <div
                      key={index}
                      className={`dropdown__option ${columnID === col.id && "dropdown__option--selected"
                        }`}
                      onClick={() => {
                        setColumnID(col.id);
