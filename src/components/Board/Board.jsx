...
//         <Sidebar />
//         <div className="board">
//           {activeBoard && activeBoard.columns && activeBoard.columns.length > 0 && (
//             <>
//               <DragDropContext onDragEnd={handleOnDragEnd}>
//                 {activeBoard.columns.map((column, colIndex) => (
//                   <Column
...
//               <h2>No board selected or no columns available</h2>
//               <button onClick={() => dispatch(openModal("addBoardModal"))}>
//                 Create New Board
//               </button>
//             </div>
//           )}
//           {/* Modals */}
//           {deleteBoardModal && <ActionBoardModal type="delete" />}
//           {clearBoardModal && <ActionBoardModal type="clear" />}
//           {resetBoardsModal && <ActionBoardModal type="reset" />}
